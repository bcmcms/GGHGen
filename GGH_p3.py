...
# with command line options: step2 --filein file:GGH_p2.root --fileout file:GGH_p3.root --mc --eventcontent AODSIM --runUnscheduled --datatier AODSIM --conditions 102X_upgrade2018_realistic_v15 --step RAW2DIGI,L1Reco,RECO,RECOSIM,EI --procModifiers premix_stage2 --nThreads 8 --era Run2_2018 --python_filename GGH_p3.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 2626
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:GGH_p2.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('step2 nevts:all'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:GGH_p3.root'),
